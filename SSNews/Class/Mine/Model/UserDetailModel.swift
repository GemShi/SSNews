...
//  SSNews
//
//  Created by GemShi on 2018/8/24.
...
struct UserDetailModel: HandyJSON {
    ...
    var descriptionHeight:CGFloat? {
        return description.boundingRect(with: CGSize(width: SCREEN_WIDTH - 30.0, height: CGFloat(MAXFLOAT)), options: .usesLineFragmentOrigin, attributes: [.font: UIFont.systemFont(ofSize: 13)], context: nil).size.height + 5
    }
    ...
    var vertified_content: String = ""
    var user_vertified: Bool = false
    
    var vertified_agency: String = ""
...
struct DongtaiOriginThread: HandyJSON {
    ...
    var content: String = ""
    var contentH: CGFloat? {
        let height = Calculate.textHeight(text: content, fontSize: 17, width: SCREEN_WIDTH - 30.0) + 5.0
